...
export function productKey(item: { brand: string; product: string; size: string }) {
  return [item.brand, item.product, item.size]
...
export function findPendingDuplicate(
  ...
  candidate: { brand: string; product: string; size: string },
  exceptId?: string,
) {
