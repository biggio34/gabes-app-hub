            ...
            <section key={area}>
              ...
              {area === "softball" ? (
                <p className="mb-3 text-sm text-slate-400">
                  ...
                  Formation, Tryouts, and Practice Planner. Scorekeeper is a
                  big-button live score for your phone. Cage Crush is on for
                  every Softball login. Wrist Coach is a separate checkbox —
